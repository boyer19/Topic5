...
console.log('The current tempurature is ' + currentTemp)    // and there's the temp!
...
let wind = weatherInfo.wind                     // Wind speed
...
let currentDeg = weatherInfo.wind
let deg = wind.deg
console.log('Current wind temp is ' + deg)